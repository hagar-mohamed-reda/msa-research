...
class NewStudentResearchController extends Controller
{
    ...
    public function index() {
        return view("dashboard.studentresearch2.index");
    }
    ...
    public function getData() { 
        ...
        if (Auth::user()->type == 'admin') {
            $query = StudentResearch::newResearch();
        } else {
        ...
        return DataTables::eloquent($query)
                        ...
                        ->addColumn('course_code', function(StudentResearch $studentresearch) {
                            return optional(optional($studentresearch->research)->course)->code;
                        })
                        ->addColumn('course', function(StudentResearch $studentresearch) {
                            return optional(optional($studentresearch->research)->course)->name;
                        })
                        ...
                        ->addColumn('student_code', function(StudentResearch $studentresearch) {
                            return optional($studentresearch->student)->code;
                        }) 
