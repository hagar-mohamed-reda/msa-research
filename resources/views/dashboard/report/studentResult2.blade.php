...
<table style="border-collapse: collapse;text-align: center;border-spacing: 0;width: 100%;display: table;border: 1px solid #ddd;direction: rtl" id="table" >
    ...
    @if (DB::table('student_courses')->whereIn('course_id', $coursesIds)->where('student_id', $student->id)->count() > 0)
    <tr> 
...
var table = null;
    ...
    function login() {
        ...
        showPage('dashboard/report/studentresult2?password='+password);
    }
    
    function search() {  
        showPage('dashboard/report/studentresult2?' + $.param(filter.filter));  
    }
