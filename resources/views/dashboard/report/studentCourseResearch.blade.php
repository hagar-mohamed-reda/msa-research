    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <li>
                    {{ $depart->name }} : {{ App\StudentCourse::join("students", "students.id", "=", "student_courses.student_id")->where('department_id', $depart->id)->where('level_id', 4)->where('course_id', $item->id)->count() }}
                </li>
                @endforeach
                </ul>
                <br>
            ...
            <td>
                {{ App\StudentCourse::join("students", "students.id", "=", "student_courses.student_id")->where('graduated', '0')->where('level_id', 4)->where('course_id', $item->id)->count() }}
            </td>
            <td>
                {{ App\StudentCourse::join("students", "students.id", "=", "student_courses.student_id")->where('graduated', '1')->where('level_id', 4)->where('course_id', $item->id)->count() }}
            </td>
        </tr>
        @endforeach
    </tbody>
