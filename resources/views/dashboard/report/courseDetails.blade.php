...
<table class="table table-bordered" id="table" >
    <thead>
        ...
        <tr>
            ...
            <td>
                {{ $item->studentCourses()->join("users", "users.id", "=", "student_courses.student_id")->where('users.graduated', 0)->count() - App\StudentResearch::where('course_id', $item->id)->count() }}
                <br>
            ...
            <td>
                {{ App\StudentCourse::query()
                    ...
                    ->where('course_id', $item->id)->where('users.graduated', 1)->count() }}
                <br>
